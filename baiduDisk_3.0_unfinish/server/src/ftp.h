...
void mysqlInit(MYSQL*,char*,char*,char*,char*);
int loginRegister(int,char*,MYSQL*);
int loginVerify(int,char*,MYSQL*);
...
void signalInit();
void getRandomSalt(char*,const int);
